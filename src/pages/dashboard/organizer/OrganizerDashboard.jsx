...
function OrganizerDashboard() {
    ...
    return (
        <main className={` ${isDark 
            ? "bg-dark" 
            : ""}
            flex flex-col w-full h-screen mt-18 px-24
        `}>
            <section className={` ${isDark 
                ? "" 
                : ""}
                max-w-7xl mx-auto flex flex-col md:flex-row flex-start md:items-center justify-between w-full gap-16
            `}
            >
                ...
                <div 
                    onClick={createEvent}
                    className="flex items-center justify-center gap-8 bg-primary px-16 py-8 f-14 text-light round-8 w-fit">
                    <GoPlus/>
            ...
            `}>
              <div className={` ${isDark 
                ...
                border border-border-header round-8 shadow-xl h-fit order-2 md:order-0
              `}>
              ...
              <div className={` ${isDark 
                ? "" 
                : ""}
                flex flex-col gap-16 order-1 md:order-0
              `}>
                <div className={` ${isDark 
                    ? "" 
                ...
                `}>
                    ...
                    <div className="bg-primary gap-8 flex items-center justify-center py-6 round-8 f-14 text-light font-medium">
                        <GoPlus/>
